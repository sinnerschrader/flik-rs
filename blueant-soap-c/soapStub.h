...
struct ns2__GeneralWebserviceException;	/* blueant.h:295 */
struct ns3__T_USCOREForeignKey;	/* blueant.h:323 */
struct ns3__T_USCOREForeignKeyList;	/* blueant.h:346 */
union _ns3__union_UserIDInfo;	/* blueant.h:381 */
struct ns3__UserIDInfo;	/* blueant.h:363 */
struct ns3__T_USCOREUser;	/* blueant.h:395 */
struct ns3__T_USCOREIdList;	/* blueant.h:415 */
struct _ns3__session;	/* blueant.h:481 */
struct _ns3__LoginRequestParameter;	/* blueant.h:499 */
struct _ns3__LoginNoAuthRequestParameter;	/* blueant.h:517 */
struct _ns3__LoginSAMLRequestParameter;	/* blueant.h:533 */
union _ns3__union_LoginImpersonateRequestParameter;	/* blueant.h:576 */
struct _ns3__LoginImpersonateRequestParameter;	/* blueant.h:549 */
struct _ns3__LogoutRequestParameter;	/* blueant.h:591 */
struct _ns3__createUserRequestParameter;	/* blueant.h:607 */
struct _ns3__searchUserRequestParameter;	/* blueant.h:665 */
struct _ns3__deleteUserRequestParameter;	/* blueant.h:731 */
struct _ns3__UserList;	/* blueant.h:749 */
struct ns2__UserManagementException;	/* blueant.h:766 */
struct _ns2__WeekFinishedException;	/* blueant.h:786 */
struct _ns2__InvalidParameterException;	/* blueant.h:806 */
struct _ns2__AssertionException;	/* blueant.h:826 */
struct _ns2__GeneralWebserviceException;	/* blueant.h:846 */
struct ns2__InvalidLicenseException;	/* blueant.h:865 */
struct _ns2__InvalidSessionException;	/* blueant.h:887 */
struct _ns2__InvalidClientException;	/* blueant.h:909 */
struct _ns2__PermissionDeniedException;	/* blueant.h:931 */
struct _ns2__InvalidUsernamePasswordCombinationException;	/* blueant.h:953 */
struct _ns2__InvalidUsernameException;	/* blueant.h:975 */
struct _ns2__InvalidDatesException;	/* blueant.h:997 */
struct _ns2__ServerMaintenanceException;	/* blueant.h:1019 */
struct _ns2__ImpersonatedUserNotFoundException;	/* blueant.h:1041 */
struct _ns2__InvalidNrOfImpersonationsException;	/* blueant.h:1063 */
struct _ns2__InvalidNamedLicenseException;	/* blueant.h:1085 */
struct _ns2__InvalidConcurrentLicenseException;	/* blueant.h:1109 */
struct __ns1__Login;	/* blueant.h:1422 */
struct __ns1__LoginNoAuth;	/* blueant.h:1499 */
struct __ns1__LoginSAML;	/* blueant.h:1576 */
struct __ns1__LoginImpersonate;	/* blueant.h:1659 */
struct __ns1__LogoutResponse;	/* blueant.h:1670 */
struct __ns1__Logout;	/* blueant.h:1734 */
struct __ns1__createUser;	/* blueant.h:1812 */
struct __ns1__deleteUserResponse;	/* blueant.h:1823 */
struct __ns1__deleteUser;	/* blueant.h:1893 */
struct __ns1__searchUser;	/* blueant.h:1971 */
