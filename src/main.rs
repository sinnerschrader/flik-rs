...
fn main() {
    let matches = App::new("flik")
        .subcommand(SubCommand::with_name("activities").about("List cached activities"))
        .subcommand(
        ...
        .subcommand(
            SubCommand::with_name("comp_billable")
                .about("ZSH completion for billable")
                .arg(Arg::with_name("project")),
        )
        .subcommand(
            SubCommand::with_name("comp_list")
                .about("ZSH completion for tasks")
                .arg(Arg::with_name("date")),
        )
        .subcommand(SubCommand::with_name("completion").about("Show path to completion"))
        .subcommand(
        ...
        .subcommand(
            SubCommand::with_name("list").about("List worktime").arg(
                Arg::with_name("date")
                    .takes_value(true)
                    .default_value("today"),
            ),
        ...
        .subcommand(SubCommand::with_name("projects").about("List cached project"))
        .subcommand(SubCommand::with_name("sync").about("Update caches"))
        .subcommand(
