...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.28 2018-03-11 00:36:37 GMT")
...
{	(void)tag;
	...
	case SOAP_TYPE__ns2__InvalidConcurrentLicenseException:
		return soap_out__ns2__InvalidConcurrentLicenseException(soap, "ns2:InvalidConcurrentLicenseException", id, (const struct _ns2__InvalidConcurrentLicenseException *)ptr, NULL);
	case SOAP_TYPE__ns2__InvalidNamedLicenseException:
		return soap_out__ns2__InvalidNamedLicenseException(soap, "ns2:InvalidNamedLicenseException", id, (const struct _ns2__InvalidNamedLicenseException *)ptr, NULL);
	case SOAP_TYPE__ns2__InvalidNrOfImpersonationsException:
		return soap_out__ns2__InvalidNrOfImpersonationsException(soap, "ns2:InvalidNrOfImpersonationsException", id, (const struct _ns2__InvalidNrOfImpersonationsException *)ptr, NULL);
	case SOAP_TYPE__ns2__ImpersonatedUserNotFoundException:
		return soap_out__ns2__ImpersonatedUserNotFoundException(soap, "ns2:ImpersonatedUserNotFoundException", id, (const struct _ns2__ImpersonatedUserNotFoundException *)ptr, NULL);
	case SOAP_TYPE__ns2__ServerMaintenanceException:
		return soap_out__ns2__ServerMaintenanceException(soap, "ns2:ServerMaintenanceException", id, (const struct _ns2__ServerMaintenanceException *)ptr, NULL);
	case SOAP_TYPE__ns2__InvalidDatesException:
		return soap_out__ns2__InvalidDatesException(soap, "ns2:InvalidDatesException", id, (const struct _ns2__InvalidDatesException *)ptr, NULL);
	case SOAP_TYPE__ns2__InvalidUsernameException:
		return soap_out__ns2__InvalidUsernameException(soap, "ns2:InvalidUsernameException", id, (const struct _ns2__InvalidUsernameException *)ptr, NULL);
	case SOAP_TYPE__ns2__InvalidUsernamePasswordCombinationException:
		return soap_out__ns2__InvalidUsernamePasswordCombinationException(soap, "ns2:InvalidUsernamePasswordCombinationException", id, (const struct _ns2__InvalidUsernamePasswordCombinationException *)ptr, NULL);
	case SOAP_TYPE__ns2__PermissionDeniedException:
		return soap_out__ns2__PermissionDeniedException(soap, "ns2:PermissionDeniedException", id, (const struct _ns2__PermissionDeniedException *)ptr, NULL);
	case SOAP_TYPE__ns2__InvalidClientException:
		return soap_out__ns2__InvalidClientException(soap, "ns2:InvalidClientException", id, (const struct _ns2__InvalidClientException *)ptr, NULL);
	case SOAP_TYPE__ns2__InvalidSessionException:
		return soap_out__ns2__InvalidSessionException(soap, "ns2:InvalidSessionException", id, (const struct _ns2__InvalidSessionException *)ptr, NULL);
	case SOAP_TYPE_ns2__InvalidLicenseException:
	...
	case SOAP_TYPE__ns2__GeneralWebserviceException:
		return soap_out__ns2__GeneralWebserviceException(soap, "ns2:GeneralWebserviceException", id, (const struct _ns2__GeneralWebserviceException *)ptr, NULL);
	case SOAP_TYPE__ns2__AssertionException:
		return soap_out__ns2__AssertionException(soap, "ns2:AssertionException", id, (const struct _ns2__AssertionException *)ptr, NULL);
	case SOAP_TYPE__ns2__InvalidParameterException:
		return soap_out__ns2__InvalidParameterException(soap, "ns2:InvalidParameterException", id, (const struct _ns2__InvalidParameterException *)ptr, NULL);
	case SOAP_TYPE__ns2__WeekFinishedException:
		return soap_out__ns2__WeekFinishedException(soap, "ns2:WeekFinishedException", id, (const struct _ns2__WeekFinishedException *)ptr, NULL);
	case SOAP_TYPE_ns2__UserManagementException:
	...
	case SOAP_TYPE__ns3__UserList:
		return soap_out__ns3__UserList(soap, "ns3:UserList", id, (const struct _ns3__UserList *)ptr, NULL);
	case SOAP_TYPE__ns3__deleteUserRequestParameter:
		return soap_out__ns3__deleteUserRequestParameter(soap, "ns3:deleteUserRequestParameter", id, (const struct _ns3__deleteUserRequestParameter *)ptr, NULL);
	case SOAP_TYPE__ns3__searchUserRequestParameter:
		return soap_out__ns3__searchUserRequestParameter(soap, "ns3:searchUserRequestParameter", id, (const struct _ns3__searchUserRequestParameter *)ptr, NULL);
	case SOAP_TYPE__ns3__createUserRequestParameter:
		return soap_out__ns3__createUserRequestParameter(soap, "ns3:createUserRequestParameter", id, (const struct _ns3__createUserRequestParameter *)ptr, NULL);
	case SOAP_TYPE__ns3__LogoutRequestParameter:
		return soap_out__ns3__LogoutRequestParameter(soap, "ns3:LogoutRequestParameter", id, (const struct _ns3__LogoutRequestParameter *)ptr, NULL);
	case SOAP_TYPE__ns3__LoginImpersonateRequestParameter:
		return soap_out__ns3__LoginImpersonateRequestParameter(soap, "ns3:LoginImpersonateRequestParameter", id, (const struct _ns3__LoginImpersonateRequestParameter *)ptr, NULL);
	case SOAP_TYPE__ns3__LoginSAMLRequestParameter:
		return soap_out__ns3__LoginSAMLRequestParameter(soap, "ns3:LoginSAMLRequestParameter", id, (const struct _ns3__LoginSAMLRequestParameter *)ptr, NULL);
	case SOAP_TYPE__ns3__LoginNoAuthRequestParameter:
		return soap_out__ns3__LoginNoAuthRequestParameter(soap, "ns3:LoginNoAuthRequestParameter", id, (const struct _ns3__LoginNoAuthRequestParameter *)ptr, NULL);
	case SOAP_TYPE__ns3__LoginRequestParameter:
		return soap_out__ns3__LoginRequestParameter(soap, "ns3:LoginRequestParameter", id, (const struct _ns3__LoginRequestParameter *)ptr, NULL);
	case SOAP_TYPE__ns3__session:
		return soap_out__ns3__session(soap, "ns3:session", id, (const struct _ns3__session *)ptr, NULL);
	case SOAP_TYPE_ns3__T_USCOREIdList:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns3__T_USCOREUserState(struct soap *soap, enum ns3__T_USCOREUserState *a)
{
	(void)soap; /* appease -Wall -Werror */
#ifdef SOAP_DEFAULT_ns3__T_USCOREUserState
	*a = SOAP_DEFAULT_ns3__T_USCOREUserState;
#else
	*a = (enum ns3__T_USCOREUserState)0;
#endif
}
...
SOAP_FMAC3 enum ns3__T_USCOREUserState * SOAP_FMAC4 soap_in_ns3__T_USCOREUserState(struct soap *soap, const char *tag, enum ns3__T_USCOREUserState *a, const char *type)
{
	...
	{	if (soap_s2ns3__T_USCOREUserState(soap, soap_value(soap), a) || soap_element_end_in(soap, tag))
			return NULL;
	}
	else
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns3__T_USCORELicenseType(struct soap *soap, enum ns3__T_USCORELicenseType *a)
{
	(void)soap; /* appease -Wall -Werror */
#ifdef SOAP_DEFAULT_ns3__T_USCORELicenseType
	*a = SOAP_DEFAULT_ns3__T_USCORELicenseType;
#else
	*a = (enum ns3__T_USCORELicenseType)0;
#endif
}
...
SOAP_FMAC3 enum ns3__T_USCORELicenseType * SOAP_FMAC4 soap_in_ns3__T_USCORELicenseType(struct soap *soap, const char *tag, enum ns3__T_USCORELicenseType *a, const char *type)
{
	...
	if (!a)
		return NULL;
	if (soap->body && !*soap->href)
	{	if (soap_s2ns3__T_USCORELicenseType(soap, soap_value(soap), a) || soap_element_end_in(soap, tag))
			return NULL;
	}
	else
...
SOAP_FMAC3 enum xsd__boolean * SOAP_FMAC4 soap_in_ns3__optionalBoolean(struct soap *soap, const char *tag, enum xsd__boolean *a, const char *type)
{
	...
	if (!a)
		return NULL;
	if (soap->body && !*soap->href)
	{	if (soap_s2ns3__optionalBoolean(soap, soap_value(soap), a) || soap_element_end_in(soap, tag))
			return NULL;
	}
	else
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns2__InvalidConcurrentLicenseException(struct soap *soap, const char *tag, int id, const struct _ns2__InvalidConcurrentLicenseException *a, const char *type)
{
	...
	soap_outliteral(soap, "ns2:cause", (char*const*)&a->cause, NULL);
	if (!a->message)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize__ns3__UserList(struct soap *soap, const struct _ns3__UserList *a)
{
	...
	{	int i;
		...
		{
			soap_embedded(soap, a->User + i, SOAP_TYPE_ns3__T_USCOREUser);
			soap_serialize_ns3__T_USCOREUser(soap, a->User + i);
		}
	}
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns3__UserList(struct soap *soap, const char *tag, int id, const struct _ns3__UserList *a, const char *type)
{
	...
	{	int i;
		for (i = 0; i < (int)a->__sizeUser; i++)
			if (soap_out_ns3__T_USCOREUser(soap, "ns3:User", -1, a->User + i, ""))
				return soap->error;
	}
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 struct _ns3__UserList * SOAP_FMAC4 soap_in__ns3__UserList(struct soap *soap, const char *tag, struct _ns3__UserList *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			{	if (a->User == NULL)
				{	if (soap_blist_User == NULL)
					...
					a->User = (struct ns3__T_USCOREUser *)soap_push_block(soap, soap_blist_User, sizeof(struct ns3__T_USCOREUser));
					if (a->User == NULL)
						return NULL;
					soap_default_ns3__T_USCOREUser(soap, a->User);
				}
				soap_revert(soap);
				if (soap_in_ns3__T_USCOREUser(soap, "ns3:User", a->User, "ns3:T_User"))
				{	a->__sizeUser++;
					a->User = NULL;
					continue;
				}
		...
		if (a->__sizeUser)
		{	a->User = (struct ns3__T_USCOREUser *)soap_save_block(soap, soap_blist_User, NULL, 1);
		}
		else
		{	a->User = NULL;
			if (soap_blist_User)
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns3__deleteUserRequestParameter(struct soap *soap, const char *tag, int id, const struct _ns3__deleteUserRequestParameter *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns3__deleteUserRequestParameter), type))
		return soap->error;
	if (!a->sessionID)
	{	if (soap_element_nil(soap, "ns3:sessionID"))
			return soap->error;
	}
	else
	if (soap_out_string(soap, "ns3:sessionID", -1, (char*const*)&a->sessionID, ""))
		return soap->error;
	if (!a->user)
	{	if (soap_element_nil(soap, "ns3:user"))
			return soap->error;
	}
	else
...
SOAP_FMAC3 struct _ns3__deleteUserRequestParameter * SOAP_FMAC4 soap_in__ns3__deleteUserRequestParameter(struct soap *soap, const char *tag, struct _ns3__deleteUserRequestParameter *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_sessionID > 0 || soap_flag_user > 0))
		{	soap->error = SOAP_OCCURS;
			return NULL;
		}
		if (soap_element_end_in(soap, tag))
...
SOAP_FMAC3 struct _ns3__searchUserRequestParameter * SOAP_FMAC4 soap_in__ns3__searchUserRequestParameter(struct soap *soap, const char *tag, struct _ns3__searchUserRequestParameter *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_sessionID > 0 || soap_flag_username > 0 || soap_flag_email > 0 || soap_flag_personID > 0 || soap_flag_permissionGroupID > 0 || soap_flag_firstname > 0 || soap_flag_lastname > 0 || soap_flag_personalNumber > 0 || soap_flag_licenseType > 0 || soap_flag_userState > 0 || soap_flag_foreignKey > 0))
		{	soap->error = SOAP_OCCURS;
			return NULL;
		}
		if (soap_element_end_in(soap, tag))
...
SOAP_FMAC3 struct _ns3__createUserRequestParameter * SOAP_FMAC4 soap_in__ns3__createUserRequestParameter(struct soap *soap, const char *tag, struct _ns3__createUserRequestParameter *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_sessionID > 0 || soap_flag_personID > 0 || soap_flag_username > 0 || soap_flag_passwort > 0 || soap_flag_permissionGroups > 0 || soap_flag_accessFrom > 0 || soap_flag_accessTo > 0 || soap_flag_licenseType > 0 || soap_flag_foreignKeyList > 0))
		{	soap->error = SOAP_OCCURS;
			return NULL;
		}
		if (soap_element_end_in(soap, tag))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns3__LoginImpersonateRequestParameter(struct soap *soap, const char *tag, int id, const struct _ns3__LoginImpersonateRequestParameter *a, const char *type)
{
	...
	if (soap_out_string(soap, "ns3:username", -1, (char*const*)&a->username, ""))
		return soap->error;
	if (!a->password)
	{	if (soap_element_nil(soap, "ns3:password"))
			return soap->error;
	}
	else
...
SOAP_FMAC3 struct _ns3__LoginImpersonateRequestParameter * SOAP_FMAC4 soap_in__ns3__LoginImpersonateRequestParameter(struct soap *soap, const char *tag, struct _ns3__LoginImpersonateRequestParameter *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_username > 0 || soap_flag_password > 0 || soap_flag_union_LoginImpersonateRequestParameter))
		{	soap->error = SOAP_OCCURS;
			return NULL;
		}
		if (soap_element_end_in(soap, tag))
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns3__LoginSAMLRequestParameter(struct soap *soap, const char *tag, int id, const struct _ns3__LoginSAMLRequestParameter *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns3__LoginSAMLRequestParameter), type))
		return soap->error;
	if (!a->SAMLartifact)
	{	if (soap_element_nil(soap, "ns3:SAMLartifact"))
			return soap->error;
	}
	else
...
SOAP_FMAC3 struct _ns3__LoginSAMLRequestParameter * SOAP_FMAC4 soap_in__ns3__LoginSAMLRequestParameter(struct soap *soap, const char *tag, struct _ns3__LoginSAMLRequestParameter *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_SAMLartifact > 0))
		{	soap->error = SOAP_OCCURS;
			return NULL;
		}
		if (soap_element_end_in(soap, tag))
...
SOAP_FMAC3 struct _ns3__session * SOAP_FMAC4 soap_in__ns3__session(struct soap *soap, const char *tag, struct _ns3__session *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_sessionID > 0 || soap_flag_personID > 0))
		{	soap->error = SOAP_OCCURS;
			return NULL;
		}
		if (soap_element_end_in(soap, tag))
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns3__T_USCOREIdList(struct soap *soap, const struct ns3__T_USCOREIdList *a)
{
	...
	{	int i;
		...
		{
			soap_embedded(soap, a->ID + i, SOAP_TYPE_ns3__id);
		}
	}
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns3__T_USCOREIdList(struct soap *soap, const char *tag, int id, const struct ns3__T_USCOREIdList *a, const char *type)
{
	...
	{	int i;
		for (i = 0; i < (int)a->__sizeID; i++)
			if (soap_out_ns3__id(soap, "ns3:ID", -1, a->ID + i, ""))
				return soap->error;
	}
	return soap_element_end_out(soap, tag);
}
...
{
	struct soap_blist *soap_blist_ID = NULL;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			{	if (a->ID == NULL)
				{	if (soap_blist_ID == NULL)
						soap_blist_ID = soap_new_block(soap);
					a->ID = (LONG64 *)soap_push_block(soap, soap_blist_ID, sizeof(LONG64));
					if (a->ID == NULL)
						return NULL;
					soap_default_ns3__id(soap, a->ID);
				}
				soap_revert(soap);
				if (soap_in_ns3__id(soap, "ns3:ID", a->ID, "ns3:id"))
				{	a->__sizeID++;
					a->ID = NULL;
					continue;
				}
		...
		if (a->ID)
			soap_pop_block(soap, soap_blist_ID);
		if (a->__sizeID)
		{	a->ID = (LONG64 *)soap_save_block(soap, soap_blist_ID, NULL, 1);
		}
		else
		{	a->ID = NULL;
			if (soap_blist_ID)
				soap_end_block(soap, soap_blist_ID);
		}
		if (soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 struct ns3__T_USCOREUser * SOAP_FMAC4 soap_in_ns3__T_USCOREUser(struct soap *soap, const char *tag, struct ns3__T_USCOREUser *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_userID > 0 || soap_flag_personID > 0 || soap_flag_username > 0 || soap_flag_permissionGroups > 0 || soap_flag_lastname > 0 || soap_flag_firstname > 0 || soap_flag_personalNumber > 0 || soap_flag_email > 0 || soap_flag_licenseType > 0 || soap_flag_userState > 0 || soap_flag_foreignKeyList > 0))
		{	soap->error = SOAP_OCCURS;
			return NULL;
		}
		if (soap_element_end_in(soap, tag))
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns3__T_USCOREForeignKeyList(struct soap *soap, const struct ns3__T_USCOREForeignKeyList *a)
{
	...
	{	int i;
		...
		{
			soap_embedded(soap, a->ForeignKey + i, SOAP_TYPE_ns3__T_USCOREForeignKey);
			soap_serialize_ns3__T_USCOREForeignKey(soap, a->ForeignKey + i);
		}
	}
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns3__T_USCOREForeignKeyList(struct soap *soap, const char *tag, int id, const struct ns3__T_USCOREForeignKeyList *a, const char *type)
{
	...
	{	int i;
		for (i = 0; i < (int)a->__sizeForeignKey; i++)
			if (soap_out_ns3__T_USCOREForeignKey(soap, "ns3:ForeignKey", -1, a->ForeignKey + i, ""))
				return soap->error;
	}
	return soap_element_end_out(soap, tag);
}
...
{
	struct soap_blist *soap_blist_ForeignKey = NULL;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			{	if (a->ForeignKey == NULL)
				{	if (soap_blist_ForeignKey == NULL)
						soap_blist_ForeignKey = soap_new_block(soap);
					a->ForeignKey = (struct ns3__T_USCOREForeignKey *)soap_push_block(soap, soap_blist_ForeignKey, sizeof(struct ns3__T_USCOREForeignKey));
					if (a->ForeignKey == NULL)
						return NULL;
					soap_default_ns3__T_USCOREForeignKey(soap, a->ForeignKey);
				}
				soap_revert(soap);
				if (soap_in_ns3__T_USCOREForeignKey(soap, "ns3:ForeignKey", a->ForeignKey, "ns3:T_ForeignKey"))
				{	a->__sizeForeignKey++;
					a->ForeignKey = NULL;
					continue;
				}
		...
		if (a->ForeignKey)
			soap_pop_block(soap, soap_blist_ForeignKey);
		if (a->__sizeForeignKey)
		{	a->ForeignKey = (struct ns3__T_USCOREForeignKey *)soap_save_block(soap, soap_blist_ForeignKey, NULL, 1);
		}
		else
		{	a->ForeignKey = NULL;
			if (soap_blist_ForeignKey)
				soap_end_block(soap, soap_blist_ForeignKey);
		}
		if (soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons3__T_USCOREUserState(struct soap *soap, enum ns3__T_USCOREUserState *const*a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_reference(soap, *a, SOAP_TYPE_ns3__T_USCOREUserState);
#endif
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons3__T_USCORELicenseType(struct soap *soap, enum ns3__T_USCORELicenseType *const*a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_reference(soap, *a, SOAP_TYPE_ns3__T_USCORELicenseType);
#endif
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTons3__id(struct soap *soap, LONG64 *const*a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_reference(soap, *a, SOAP_TYPE_ns3__id);
#endif
}
