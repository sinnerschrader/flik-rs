...
/* baseService.h
   Generated by wsdl2h 2.8.28 from https://blueant.sinnerschrader.com/blueant/services/BaseService?wsdl and typemap.dat
   2018-03-11 00:31:43 GMT
...
/// - soap_default_ns2__GeneralWebserviceException(soap*, ns2__GeneralWebserviceException*) reset members to default
/// - int soap_read_ns2__GeneralWebserviceException(soap*, ns2__GeneralWebserviceException*) deserialize from a source
/// - int soap_write_ns2__GeneralWebserviceException(soap*, ns2__GeneralWebserviceException*) serialize to a sink
/// - ns2__GeneralWebserviceException* soap_dup_ns2__GeneralWebserviceException(soap*, ns2__GeneralWebserviceException* dst, ns2__GeneralWebserviceException *src) returns deep copy of ns2__GeneralWebserviceException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// Element "cause" of XSD type xs:anyType.
    _XML                                 cause                          1;	///< Optional (xsi:nil when NULL) element.
/// Element "message" of XSD type xs:string.
    char*                                message                        1;	///< Optional (xsi:nil when NULL) element.
};
...
/// - soap_default_ns3__T_USCOREForeignKey(soap*, ns3__T_USCOREForeignKey*) reset members to default
/// - int soap_read_ns3__T_USCOREForeignKey(soap*, ns3__T_USCOREForeignKey*) deserialize from a source
/// - int soap_write_ns3__T_USCOREForeignKey(soap*, ns3__T_USCOREForeignKey*) serialize to a sink
/// - ns3__T_USCOREForeignKey* soap_dup_ns3__T_USCOREForeignKey(soap*, ns3__T_USCOREForeignKey* dst, ns3__T_USCOREForeignKey *src) returns deep copy of ns3__T_USCOREForeignKey src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// Element "foreignID" of XSD type xs:string.
    char*                                foreignID                      1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   Name of the foreign system (see masterdata:getForeignSystem)
/// </BLOCKQUOTE></PRE>
/// Element "foreignSystem" of XSD type xs:string.
    char*                                foreignSystem                  1;	///< Optional (xsi:nil when NULL) element.
};
...
/// - soap_default_ns3__T_USCOREForeignKeyList(soap*, ns3__T_USCOREForeignKeyList*) reset members to default
/// - int soap_read_ns3__T_USCOREForeignKeyList(soap*, ns3__T_USCOREForeignKeyList*) deserialize from a source
/// - int soap_write_ns3__T_USCOREForeignKeyList(soap*, ns3__T_USCOREForeignKeyList*) serialize to a sink
/// - ns3__T_USCOREForeignKeyList* soap_dup_ns3__T_USCOREForeignKeyList(soap*, ns3__T_USCOREForeignKeyList* dst, ns3__T_USCOREForeignKeyList *src) returns deep copy of ns3__T_USCOREForeignKeyList src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// Array struct ns3__T_USCOREForeignKey* of size 0..unbounded.
    struct ns3__T_USCOREForeignKey*      ForeignKey                     0;
};

/// @brief "http://base.blueant.axis.proventis.net/":UserIDInfo is a complexType.
///
/// struct ns3__UserIDInfo operations:
/// - soap_default_ns3__UserIDInfo(soap*, ns3__UserIDInfo*) reset members to default
/// - int soap_read_ns3__UserIDInfo(soap*, ns3__UserIDInfo*) deserialize from a source
/// - int soap_write_ns3__UserIDInfo(soap*, ns3__UserIDInfo*) serialize to a sink
/// - ns3__UserIDInfo* soap_dup_ns3__UserIDInfo(soap*, ns3__UserIDInfo* dst, ns3__UserIDInfo *src) returns deep copy of ns3__UserIDInfo src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default_ns3__T_USCOREUser(soap*, ns3__T_USCOREUser*) reset members to default
/// - int soap_read_ns3__T_USCOREUser(soap*, ns3__T_USCOREUser*) deserialize from a source
/// - int soap_write_ns3__T_USCOREUser(soap*, ns3__T_USCOREUser*) serialize to a sink
/// - ns3__T_USCOREUser* soap_dup_ns3__T_USCOREUser(soap*, ns3__T_USCOREUser* dst, ns3__T_USCOREUser *src) returns deep copy of ns3__T_USCOREUser src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// Element "email" of XSD type xs:string.
    char*                                email                          1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
...
/// Element "foreignKeyList" of XSD type "http://base.blueant.axis.proventis.net/":T_ForeignKeyList.
    struct ns3__T_USCOREForeignKeyList*  foreignKeyList                 1;	///< Optional (xsi:nil when NULL) element.
};

/// @brief "http://base.blueant.axis.proventis.net/":T_IdList is a complexType.
///
/// struct ns3__T_USCOREIdList operations:
/// - soap_default_ns3__T_USCOREIdList(soap*, ns3__T_USCOREIdList*) reset members to default
/// - int soap_read_ns3__T_USCOREIdList(soap*, ns3__T_USCOREIdList*) deserialize from a source
/// - int soap_write_ns3__T_USCOREIdList(soap*, ns3__T_USCOREIdList*) serialize to a sink
/// - ns3__T_USCOREIdList* soap_dup_ns3__T_USCOREIdList(soap*, ns3__T_USCOREIdList* dst, ns3__T_USCOREIdList *src) returns deep copy of ns3__T_USCOREIdList src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns3__session(soap*, _ns3__session*) reset members to default
/// - int soap_read__ns3__session(soap*, _ns3__session*) deserialize from a source
/// - int soap_write__ns3__session(soap*, _ns3__session*) serialize to a sink
/// - _ns3__session* soap_dup__ns3__session(soap*, _ns3__session* dst, _ns3__session *src) returns deep copy of _ns3__session src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns3__LoginRequestParameter(soap*, _ns3__LoginRequestParameter*) reset members to default
/// - int soap_read__ns3__LoginRequestParameter(soap*, _ns3__LoginRequestParameter*) deserialize from a source
/// - int soap_write__ns3__LoginRequestParameter(soap*, _ns3__LoginRequestParameter*) serialize to a sink
/// - _ns3__LoginRequestParameter* soap_dup__ns3__LoginRequestParameter(soap*, _ns3__LoginRequestParameter* dst, _ns3__LoginRequestParameter *src) returns deep copy of _ns3__LoginRequestParameter src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns3__LoginNoAuthRequestParameter(soap*, _ns3__LoginNoAuthRequestParameter*) reset members to default
/// - int soap_read__ns3__LoginNoAuthRequestParameter(soap*, _ns3__LoginNoAuthRequestParameter*) deserialize from a source
/// - int soap_write__ns3__LoginNoAuthRequestParameter(soap*, _ns3__LoginNoAuthRequestParameter*) serialize to a sink
/// - _ns3__LoginNoAuthRequestParameter* soap_dup__ns3__LoginNoAuthRequestParameter(soap*, _ns3__LoginNoAuthRequestParameter* dst, _ns3__LoginNoAuthRequestParameter *src) returns deep copy of _ns3__LoginNoAuthRequestParameter src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns3__LoginSAMLRequestParameter(soap*, _ns3__LoginSAMLRequestParameter*) reset members to default
/// - int soap_read__ns3__LoginSAMLRequestParameter(soap*, _ns3__LoginSAMLRequestParameter*) deserialize from a source
/// - int soap_write__ns3__LoginSAMLRequestParameter(soap*, _ns3__LoginSAMLRequestParameter*) serialize to a sink
/// - _ns3__LoginSAMLRequestParameter* soap_dup__ns3__LoginSAMLRequestParameter(soap*, _ns3__LoginSAMLRequestParameter* dst, _ns3__LoginSAMLRequestParameter *src) returns deep copy of _ns3__LoginSAMLRequestParameter src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns3__LoginImpersonateRequestParameter(soap*, _ns3__LoginImpersonateRequestParameter*) reset members to default
/// - int soap_read__ns3__LoginImpersonateRequestParameter(soap*, _ns3__LoginImpersonateRequestParameter*) deserialize from a source
/// - int soap_write__ns3__LoginImpersonateRequestParameter(soap*, _ns3__LoginImpersonateRequestParameter*) serialize to a sink
/// - _ns3__LoginImpersonateRequestParameter* soap_dup__ns3__LoginImpersonateRequestParameter(soap*, _ns3__LoginImpersonateRequestParameter* dst, _ns3__LoginImpersonateRequestParameter *src) returns deep copy of _ns3__LoginImpersonateRequestParameter src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// Element "ImpersonateUsername" of XSD type xs:string.
    char*                                ImpersonateUsername            1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   userID of the user to impersonate
/// </BLOCKQUOTE></PRE>
/// Element "ImpersonateUserID" of XSD type "http://base.blueant.axis.proventis.net/":id.
    ns3__id*                             ImpersonateUserID              1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
...
/// Element "ImpersonateForeignKey" of XSD type "http://base.blueant.axis.proventis.net/":T_ForeignKey.
    struct ns3__T_USCOREForeignKey*      ImpersonateForeignKey          1;	///< Optional (xsi:nil when NULL) element.
...
/// - soap_default__ns3__LogoutRequestParameter(soap*, _ns3__LogoutRequestParameter*) reset members to default
/// - int soap_read__ns3__LogoutRequestParameter(soap*, _ns3__LogoutRequestParameter*) deserialize from a source
/// - int soap_write__ns3__LogoutRequestParameter(soap*, _ns3__LogoutRequestParameter*) serialize to a sink
/// - _ns3__LogoutRequestParameter* soap_dup__ns3__LogoutRequestParameter(soap*, _ns3__LogoutRequestParameter* dst, _ns3__LogoutRequestParameter *src) returns deep copy of _ns3__LogoutRequestParameter src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns3__createUserRequestParameter(soap*, _ns3__createUserRequestParameter*) reset members to default
/// - int soap_read__ns3__createUserRequestParameter(soap*, _ns3__createUserRequestParameter*) deserialize from a source
/// - int soap_write__ns3__createUserRequestParameter(soap*, _ns3__createUserRequestParameter*) serialize to a sink
/// - _ns3__createUserRequestParameter* soap_dup__ns3__createUserRequestParameter(soap*, _ns3__createUserRequestParameter* dst, _ns3__createUserRequestParameter *src) returns deep copy of _ns3__createUserRequestParameter src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// Element "passwort" of XSD type xs:string.
    char*                                passwort                       1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
...
/// </BLOCKQUOTE></PRE>
/// Element "permissionGroups" of XSD type "http://base.blueant.axis.proventis.net/":T_IdList.
    struct ns3__T_USCOREIdList*          permissionGroups               1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   only valid for contacts - startdate of access - current day if not given
/// </BLOCKQUOTE></PRE>
/// Element "accessFrom" of XSD type xs:date.
    xsd__date                            accessFrom                     1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   only valid for contacts - enddate of access
/// </BLOCKQUOTE></PRE>
/// Element "accessTo" of XSD type xs:date.
    xsd__date                            accessTo                       1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   the type of license to use for this user - named license if not given
/// </BLOCKQUOTE></PRE>
/// Element "licenseType" of XSD type "http://base.blueant.axis.proventis.net/":T_LicenseType.
    enum ns3__T_USCORELicenseType*       licenseType                    1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   List of foreign keys
/// </BLOCKQUOTE></PRE>
/// Element "foreignKeyList" of XSD type "http://base.blueant.axis.proventis.net/":T_ForeignKeyList.
...
/// - soap_default__ns3__searchUserRequestParameter(soap*, _ns3__searchUserRequestParameter*) reset members to default
/// - int soap_read__ns3__searchUserRequestParameter(soap*, _ns3__searchUserRequestParameter*) deserialize from a source
/// - int soap_write__ns3__searchUserRequestParameter(soap*, _ns3__searchUserRequestParameter*) serialize to a sink
/// - _ns3__searchUserRequestParameter* soap_dup__ns3__searchUserRequestParameter(soap*, _ns3__searchUserRequestParameter* dst, _ns3__searchUserRequestParameter *src) returns deep copy of _ns3__searchUserRequestParameter src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// </BLOCKQUOTE></PRE>
/// Element "username" of XSD type xs:string.
    char*                                username                       1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
...
/// </BLOCKQUOTE></PRE>
/// Element "personID" of XSD type "http://base.blueant.axis.proventis.net/":id.
    ns3__id*                             personID                       1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   permission group to search for
/// </BLOCKQUOTE></PRE>
/// Element "permissionGroupID" of XSD type "http://base.blueant.axis.proventis.net/":id.
    ns3__id*                             permissionGroupID              1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   firstname to search for
/// </BLOCKQUOTE></PRE>
/// Element "firstname" of XSD type xs:string.
    char*                                firstname                      1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   lastname to search for
/// </BLOCKQUOTE></PRE>
/// Element "lastname" of XSD type xs:string.
    char*                                lastname                       1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   the personnumber to search for
/// </BLOCKQUOTE></PRE>
/// Element "personalNumber" of XSD type xs:string.
    char*                                personalNumber                 1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   the type of license assigned to this user
/// </BLOCKQUOTE></PRE>
/// Element "licenseType" of XSD type "http://base.blueant.axis.proventis.net/":T_LicenseType.
...
/// </BLOCKQUOTE></PRE>
/// Element "userState" of XSD type "http://base.blueant.axis.proventis.net/":T_UserState.
    enum ns3__T_USCOREUserState*         userState                      1;	///< Optional (xsi:nil when NULL) element.
/// <PRE><BLOCKQUOTE>
///   foreign keys
/// </BLOCKQUOTE></PRE>
/// Element "foreignKey" of XSD type "http://base.blueant.axis.proventis.net/":T_ForeignKey.
    struct ns3__T_USCOREForeignKey*      foreignKey                     1;	///< Optional (xsi:nil when NULL) element.
};
...
/// - soap_default__ns3__deleteUserRequestParameter(soap*, _ns3__deleteUserRequestParameter*) reset members to default
/// - int soap_read__ns3__deleteUserRequestParameter(soap*, _ns3__deleteUserRequestParameter*) deserialize from a source
/// - int soap_write__ns3__deleteUserRequestParameter(soap*, _ns3__deleteUserRequestParameter*) serialize to a sink
/// - _ns3__deleteUserRequestParameter* soap_dup__ns3__deleteUserRequestParameter(soap*, _ns3__deleteUserRequestParameter* dst, _ns3__deleteUserRequestParameter *src) returns deep copy of _ns3__deleteUserRequestParameter src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns3__UserList(soap*, _ns3__UserList*) reset members to default
/// - int soap_read__ns3__UserList(soap*, _ns3__UserList*) deserialize from a source
/// - int soap_write__ns3__UserList(soap*, _ns3__UserList*) serialize to a sink
/// - _ns3__UserList* soap_dup__ns3__UserList(soap*, _ns3__UserList* dst, _ns3__UserList *src) returns deep copy of _ns3__UserList src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// Array struct ns3__T_USCOREUser* of size 0..unbounded.
    struct ns3__T_USCOREUser*            User                           0;
};
...
/// - soap_default_ns2__UserManagementException(soap*, ns2__UserManagementException*) reset members to default
/// - int soap_read_ns2__UserManagementException(soap*, ns2__UserManagementException*) deserialize from a source
/// - int soap_write_ns2__UserManagementException(soap*, ns2__UserManagementException*) serialize to a sink
/// - ns2__UserManagementException* soap_dup_ns2__UserManagementException(soap*, ns2__UserManagementException* dst, ns2__UserManagementException *src) returns deep copy of ns2__UserManagementException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__WeekFinishedException(soap*, _ns2__WeekFinishedException*) reset members to default
/// - int soap_read__ns2__WeekFinishedException(soap*, _ns2__WeekFinishedException*) deserialize from a source
/// - int soap_write__ns2__WeekFinishedException(soap*, _ns2__WeekFinishedException*) serialize to a sink
/// - _ns2__WeekFinishedException* soap_dup__ns2__WeekFinishedException(soap*, _ns2__WeekFinishedException* dst, _ns2__WeekFinishedException *src) returns deep copy of _ns2__WeekFinishedException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__InvalidParameterException(soap*, _ns2__InvalidParameterException*) reset members to default
/// - int soap_read__ns2__InvalidParameterException(soap*, _ns2__InvalidParameterException*) deserialize from a source
/// - int soap_write__ns2__InvalidParameterException(soap*, _ns2__InvalidParameterException*) serialize to a sink
/// - _ns2__InvalidParameterException* soap_dup__ns2__InvalidParameterException(soap*, _ns2__InvalidParameterException* dst, _ns2__InvalidParameterException *src) returns deep copy of _ns2__InvalidParameterException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__AssertionException(soap*, _ns2__AssertionException*) reset members to default
/// - int soap_read__ns2__AssertionException(soap*, _ns2__AssertionException*) deserialize from a source
/// - int soap_write__ns2__AssertionException(soap*, _ns2__AssertionException*) serialize to a sink
/// - _ns2__AssertionException* soap_dup__ns2__AssertionException(soap*, _ns2__AssertionException* dst, _ns2__AssertionException *src) returns deep copy of _ns2__AssertionException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__GeneralWebserviceException(soap*, _ns2__GeneralWebserviceException*) reset members to default
/// - int soap_read__ns2__GeneralWebserviceException(soap*, _ns2__GeneralWebserviceException*) deserialize from a source
/// - int soap_write__ns2__GeneralWebserviceException(soap*, _ns2__GeneralWebserviceException*) serialize to a sink
/// - _ns2__GeneralWebserviceException* soap_dup__ns2__GeneralWebserviceException(soap*, _ns2__GeneralWebserviceException* dst, _ns2__GeneralWebserviceException *src) returns deep copy of _ns2__GeneralWebserviceException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default_ns2__InvalidLicenseException(soap*, ns2__InvalidLicenseException*) reset members to default
/// - int soap_read_ns2__InvalidLicenseException(soap*, ns2__InvalidLicenseException*) deserialize from a source
/// - int soap_write_ns2__InvalidLicenseException(soap*, ns2__InvalidLicenseException*) serialize to a sink
/// - ns2__InvalidLicenseException* soap_dup_ns2__InvalidLicenseException(soap*, ns2__InvalidLicenseException* dst, ns2__InvalidLicenseException *src) returns deep copy of ns2__InvalidLicenseException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__InvalidSessionException(soap*, _ns2__InvalidSessionException*) reset members to default
/// - int soap_read__ns2__InvalidSessionException(soap*, _ns2__InvalidSessionException*) deserialize from a source
/// - int soap_write__ns2__InvalidSessionException(soap*, _ns2__InvalidSessionException*) serialize to a sink
/// - _ns2__InvalidSessionException* soap_dup__ns2__InvalidSessionException(soap*, _ns2__InvalidSessionException* dst, _ns2__InvalidSessionException *src) returns deep copy of _ns2__InvalidSessionException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__InvalidClientException(soap*, _ns2__InvalidClientException*) reset members to default
/// - int soap_read__ns2__InvalidClientException(soap*, _ns2__InvalidClientException*) deserialize from a source
/// - int soap_write__ns2__InvalidClientException(soap*, _ns2__InvalidClientException*) serialize to a sink
/// - _ns2__InvalidClientException* soap_dup__ns2__InvalidClientException(soap*, _ns2__InvalidClientException* dst, _ns2__InvalidClientException *src) returns deep copy of _ns2__InvalidClientException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__PermissionDeniedException(soap*, _ns2__PermissionDeniedException*) reset members to default
/// - int soap_read__ns2__PermissionDeniedException(soap*, _ns2__PermissionDeniedException*) deserialize from a source
/// - int soap_write__ns2__PermissionDeniedException(soap*, _ns2__PermissionDeniedException*) serialize to a sink
/// - _ns2__PermissionDeniedException* soap_dup__ns2__PermissionDeniedException(soap*, _ns2__PermissionDeniedException* dst, _ns2__PermissionDeniedException *src) returns deep copy of _ns2__PermissionDeniedException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__InvalidUsernamePasswordCombinationException(soap*, _ns2__InvalidUsernamePasswordCombinationException*) reset members to default
/// - int soap_read__ns2__InvalidUsernamePasswordCombinationException(soap*, _ns2__InvalidUsernamePasswordCombinationException*) deserialize from a source
/// - int soap_write__ns2__InvalidUsernamePasswordCombinationException(soap*, _ns2__InvalidUsernamePasswordCombinationException*) serialize to a sink
/// - _ns2__InvalidUsernamePasswordCombinationException* soap_dup__ns2__InvalidUsernamePasswordCombinationException(soap*, _ns2__InvalidUsernamePasswordCombinationException* dst, _ns2__InvalidUsernamePasswordCombinationException *src) returns deep copy of _ns2__InvalidUsernamePasswordCombinationException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__InvalidUsernameException(soap*, _ns2__InvalidUsernameException*) reset members to default
/// - int soap_read__ns2__InvalidUsernameException(soap*, _ns2__InvalidUsernameException*) deserialize from a source
/// - int soap_write__ns2__InvalidUsernameException(soap*, _ns2__InvalidUsernameException*) serialize to a sink
/// - _ns2__InvalidUsernameException* soap_dup__ns2__InvalidUsernameException(soap*, _ns2__InvalidUsernameException* dst, _ns2__InvalidUsernameException *src) returns deep copy of _ns2__InvalidUsernameException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__InvalidDatesException(soap*, _ns2__InvalidDatesException*) reset members to default
/// - int soap_read__ns2__InvalidDatesException(soap*, _ns2__InvalidDatesException*) deserialize from a source
/// - int soap_write__ns2__InvalidDatesException(soap*, _ns2__InvalidDatesException*) serialize to a sink
/// - _ns2__InvalidDatesException* soap_dup__ns2__InvalidDatesException(soap*, _ns2__InvalidDatesException* dst, _ns2__InvalidDatesException *src) returns deep copy of _ns2__InvalidDatesException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__ServerMaintenanceException(soap*, _ns2__ServerMaintenanceException*) reset members to default
/// - int soap_read__ns2__ServerMaintenanceException(soap*, _ns2__ServerMaintenanceException*) deserialize from a source
/// - int soap_write__ns2__ServerMaintenanceException(soap*, _ns2__ServerMaintenanceException*) serialize to a sink
/// - _ns2__ServerMaintenanceException* soap_dup__ns2__ServerMaintenanceException(soap*, _ns2__ServerMaintenanceException* dst, _ns2__ServerMaintenanceException *src) returns deep copy of _ns2__ServerMaintenanceException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__ImpersonatedUserNotFoundException(soap*, _ns2__ImpersonatedUserNotFoundException*) reset members to default
/// - int soap_read__ns2__ImpersonatedUserNotFoundException(soap*, _ns2__ImpersonatedUserNotFoundException*) deserialize from a source
/// - int soap_write__ns2__ImpersonatedUserNotFoundException(soap*, _ns2__ImpersonatedUserNotFoundException*) serialize to a sink
/// - _ns2__ImpersonatedUserNotFoundException* soap_dup__ns2__ImpersonatedUserNotFoundException(soap*, _ns2__ImpersonatedUserNotFoundException* dst, _ns2__ImpersonatedUserNotFoundException *src) returns deep copy of _ns2__ImpersonatedUserNotFoundException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__InvalidNrOfImpersonationsException(soap*, _ns2__InvalidNrOfImpersonationsException*) reset members to default
/// - int soap_read__ns2__InvalidNrOfImpersonationsException(soap*, _ns2__InvalidNrOfImpersonationsException*) deserialize from a source
/// - int soap_write__ns2__InvalidNrOfImpersonationsException(soap*, _ns2__InvalidNrOfImpersonationsException*) serialize to a sink
/// - _ns2__InvalidNrOfImpersonationsException* soap_dup__ns2__InvalidNrOfImpersonationsException(soap*, _ns2__InvalidNrOfImpersonationsException* dst, _ns2__InvalidNrOfImpersonationsException *src) returns deep copy of _ns2__InvalidNrOfImpersonationsException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__InvalidNamedLicenseException(soap*, _ns2__InvalidNamedLicenseException*) reset members to default
/// - int soap_read__ns2__InvalidNamedLicenseException(soap*, _ns2__InvalidNamedLicenseException*) deserialize from a source
/// - int soap_write__ns2__InvalidNamedLicenseException(soap*, _ns2__InvalidNamedLicenseException*) serialize to a sink
/// - _ns2__InvalidNamedLicenseException* soap_dup__ns2__InvalidNamedLicenseException(soap*, _ns2__InvalidNamedLicenseException* dst, _ns2__InvalidNamedLicenseException *src) returns deep copy of _ns2__InvalidNamedLicenseException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
/// - soap_default__ns2__InvalidConcurrentLicenseException(soap*, _ns2__InvalidConcurrentLicenseException*) reset members to default
/// - int soap_read__ns2__InvalidConcurrentLicenseException(soap*, _ns2__InvalidConcurrentLicenseException*) deserialize from a source
/// - int soap_write__ns2__InvalidConcurrentLicenseException(soap*, _ns2__InvalidConcurrentLicenseException*) serialize to a sink
/// - _ns2__InvalidConcurrentLicenseException* soap_dup__ns2__InvalidConcurrentLicenseException(soap*, _ns2__InvalidConcurrentLicenseException* dst, _ns2__InvalidConcurrentLicenseException *src) returns deep copy of _ns2__InvalidConcurrentLicenseException src into dst, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
...
@section BaseBinding_ports Endpoints of Binding "BaseBinding"
...
creates a new session for the given user, using the given password
  ...
  - Action: "http://blueant.axis.proventis.net/Login"
  ...
  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":InvalidUsernamePasswordCombinationException (literal)

  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":InvalidDatesException (literal)

  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":ServerMaintenanceException (literal)

  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":InvalidNamedLicenseException (literal)

  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":InvalidConcurrentLicenseException (literal)

  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":GeneralWebserviceException (literal)
...
creates a new session for the given user, WITHOUT a password.
  ...
  - Action: "http://blueant.axis.proventis.net/LoginNoAuth"
  ...
  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":InvalidUsernameException (literal)
...
Login to BlueAnt using SAML artifact via SSO
  ...
  - Action: "http://blueant.axis.proventis.net/LoginSAML"
...
Login to BlueAnt and impersonate another user
  ...
  - Action: "http://blueant.axis.proventis.net/LoginImpersonate"
  ...
  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":ImpersonatedUserNotFoundException (literal)

  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":InvalidNrOfImpersonationsException (literal)
...
This service logs out a valid sessionID in BlueAnt.
  ...
  - Action: "http://blueant.axis.proventis.net/Logout"
  ...
  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":InvalidSessionException (literal)

  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":InvalidClientException (literal)

  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":PermissionDeniedException (literal)

  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":InvalidParameterException (literal)
...
Create a new user in BlueAnt.
  ...
  - Action: "http://blueant.axis.proventis.net/createUser"
  ...
  - SOAP Output Fault: "http://exception.blueant.axis.proventis.net/":AssertionException (literal)
...
Deletes a user in BlueAnt.
  ...
  - Action: "http://blueant.axis.proventis.net/deleteUser"
...
searches BlueAnt for users, matching the given criteria
  ...
  - Action: "http://blueant.axis.proventis.net/searchUser"
