...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.28 2018-03-11 00:36:37 GMT")
...
{	struct __ns1__LoginNoAuth soap_tmp___ns1__LoginNoAuth;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns1__LoginNoAuth(soap, &soap_tmp___ns1__LoginNoAuth, "-ns1:LoginNoAuth", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns1__LoginSAML soap_tmp___ns1__LoginSAML;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns1__LoginSAML(soap, &soap_tmp___ns1__LoginSAML, "-ns1:LoginSAML", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns1__LoginImpersonate soap_tmp___ns1__LoginImpersonate;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns1__LoginImpersonate(soap, &soap_tmp___ns1__LoginImpersonate, "-ns1:LoginImpersonate", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns1__deleteUser soap_tmp___ns1__deleteUser;
	...
	if (!_param_2)
		return soap_closesock(soap);
	soap_default___ns1__deleteUserResponse(soap, _param_2);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
...
{	struct __ns1__searchUser soap_tmp___ns1__searchUser;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns1__searchUser(soap, &soap_tmp___ns1__searchUser, "-ns1:searchUser", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
